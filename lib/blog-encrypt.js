(() => {
  ...
  async function decrypt(decryptKey, iv, hmacKey) {
    ...
    const result = await cryptoObj.subtle.decrypt({
      ...
      hideButton.textContent = '重新锁起来 (ﾟ3ﾟ)～♪';
      hideButton.type = 'button';
      hideButton.setAttribute('class', 'mdl-button mdl-js-button mdl-button--raised mdl-button--colored mdl-js-ripple-effect lock_button');
